      ...
      <section className="what-we-do" id="what-we-do">
        <div className="container">
          ...
          <div className="service-container">
            <div className="service-wrap" id="digital-marketing">
              <div className="service-content">
                <div className="service-content-wrap">
                  <p className="service-title">Digital Marketing</p>
                  <p className="service-description">
                    At Neon Strategies, we harness the power of digital
                    marketing to elevate your brand and connect you with your
                    target audience. Our comprehensive digital marketing
                    services are designed to drive traffic, increase engagement,
            ...
            <div className="service-wrap" id="branding">
              <div className="service-content">
                <div className="service-content-wrap">
                  <p className="service-title">Branding</p>
                  <p className="service-description">
                    At Neon Strategies, we understand that a strong brand is the
                    foundation of any successful business. Our branding services
                    are designed to create a memorable and impactful brand
                    identity that resonates with your target audience and sets
            ...
            <div className="service-wrap" id="creative-services">
              <div className="service-content">
                <div className="service-content-wrap">
                  <p className="service-title">Creative Services</p>
                  <p className="service-description">
                    At Neon Strategies, our Creative Services team is dedicated
                    to bringing your vision to life with innovative and
                    captivating designs. We believe that creativity is at the
                    heart of effective marketing, and we strive to create visual
                    content that not only captures attention but also drives
